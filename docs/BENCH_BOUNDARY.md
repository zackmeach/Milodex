...
>
> **Implementation status — Phase D1 (2026-05-14).**
>
...
> * **All remaining submit methods** (`submit_backtest`, `submit_promote_to_paper`, `submit_start_paper_runner`, `submit_stop_paper_runner`) **remain Phase B stubs** that return a `not_submit_capable_phase_b` blocker. They will be wired one action family at a time per ADR 0051 §10 (Phases D2 → E → F).
