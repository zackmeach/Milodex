...
> **Phase 2 was formally closed on 2026-05-04 via [ADR 0025](adr/0025-phase-2-is-closed-and-phase-3-may-open.md).** This document is now a historical record. All four §3 carry items closed; both §5 exit criteria (C-1, C-2) closed. New planning belongs in [PHASE3_PLANNING.md](PHASE3_PLANNING.md). Section §4 deferred candidates ((i) second research-target, (ii) micro_live, (iii) concurrent multi-strategy, GUI, installer) carry forward as Phase 3 menu items, not commitments.
