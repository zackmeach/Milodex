...
**Interim guardrail (effective immediately, until this ADR is implemented).** Do **not** co-run multiple strategies on the **same symbol and same account**. This is an operational constraint, not a code enforcement yet.
