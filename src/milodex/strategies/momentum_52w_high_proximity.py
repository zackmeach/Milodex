...
class Momentum52wHighProximityStrategy(Strategy):
    ...
    parameter_specs = (
        StrategyParameterSpec("lookback_days", expected_types=(int,)),
        StrategyParameterSpec("proximity_threshold", expected_types=(int, float)),
        StrategyParameterSpec("sma_exit_length", expected_types=(int,)),
